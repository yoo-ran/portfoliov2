...
export default function Header({ menuOpen, onToggleMenu }: HeaderProps) {
  return (
    <header className="fixed top-4 z-50 flexRow border rounded-md w-1/4 md:w-1/2 lg:w-1/3 px-4 py-1 backdrop-blur-md">
      <p className="font-logo font-bold italic text-lg md:text-xl lg:text-2xl">YR</p>

      {/* Desktop nav */}
      <nav className="hidden md:flex gap-x-2 lg:gap-x-4 uppercase font-black font-title text-md lg:text-xl">
